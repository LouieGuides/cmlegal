        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <Link
              key={index}
              href={service.href}
              className="card group w-full h-[240px] bg-white border text-black rounded-none border-gray-300 shadow-sm transition-all duration-300 hover:bg-[#0C0950] hover:text-white no-underline cursor-pointer"
            ...
            >
              <div className="card-body p-6 flex flex-col">
                ...
                <div className="flex items-center gap-1 text-blue-600 group-hover:text-white hover:underline transition-colors duration-200 mt-auto">

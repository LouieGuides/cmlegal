          ...
          <div className="max-w-screen-2xl mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-10">
              <nav className="flex flex-col gap-2">
                ...
                <a className="link link-hover">Partner Visa</a>
                <a className="link link-hover">Family & Parent Visa</a>
                <a className="link link-hover">Sponsored Visa</a>
                <a className="link link-hover">Visa Appeal</a>
                <a className="link link-hover">All Other Visa</a>
              </nav>
              <nav className="flex flex-col gap-2">
              ...
              <nav className="flex flex-col gap-2">
                ...
                <a className="link link-hover">Partner Visa Assessment</a>
                <a className="link link-hover">Points Calculator</a>
                <a className="link link-hover">Parent Visa Assessment</a>
              </nav>
            </div>
          </div>
        </footer>
            ...
            <nav>
              <div className="flex gap-4">
                ...
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-white fill-current" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">

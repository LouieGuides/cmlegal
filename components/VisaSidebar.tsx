...
export default function VisaSidebar() {
  ...
  return (
    <aside className="w-full lg:w-64 h-[310px] sticky top-10 border-r border-gray-200 bg-[#d4ebf8] text-black p-6">
            ...
            <Link
              ...
              className={`block px-4 py-2 rounded-md transition font-medium ${
                isActive
                  ...
                  : 'hover:bg-[#161179]/70 text-black/90 hover:text-white'
              }`}
            >
              {link.label}
            </Link>
